...
public class IntegracaoFormatadorTest {
  ...
  @Test
  public void testaFormatacaoExemplos() throws Exception {
  ...
  @Test
  public void testaFormatacaoAjuda() throws Exception {
  ...
  private void testaAjuda(File ajuda) throws Exception {
    if (ajuda.isDirectory()) {
      ...
      if (ajuda.getName().endsWith(".por")) {
        ...
        String codigoPortugol = new String(Files.readAllBytes(Paths.get(ajuda.toURI())), StandardCharsets.ISO_8859_1);
        ...
        ajudaPath = ajudaPath.substring(indicePasta);
        ...
        String codigoHTMLCorreto = ResourceHandle.readInternalResourceFile(nomehtml, "ISO-8859-1");
